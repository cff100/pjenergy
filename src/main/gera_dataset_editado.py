...
def gera_dataset_editado(caminho_relativo_dataset_unico: Path | str = CAMINHO_RELATIVO_DATASET_UNIDO, 
                        caminho_absoluto_dataset_editado: Path = CAMINHO_ABSOLUTO_DATASET_EDITADO) -> xr.Dataset:
    "Gera a forma final do dataset único"
    
    ds = edita_dataset_unico(caminho_relativo_dataset_unico, caminho_absoluto_dataset_editado)
    return ds
